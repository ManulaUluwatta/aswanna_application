...
import 'package:aswanna_application/screens/edit_address/edit_address_screen.dart';
...
class _BodyState extends State<Body> {
  ...
  final AddressesStream addressesStream = AddressesStream(AuthService().currentUser.uid);
  ...
  Future<bool> deleteButtonCallback(
    ...
    if (confirmDeletion) {
      ...
      try {
        status =
            await UserDatabaseService().deleteAddressForCurrentUser(addressId);
        if (status == true) {
