...
import 'package:aswanna_application/screens/product_details/components/product_description.dart';
import 'package:aswanna_application/screens/product_details/provider_models/ProductActions.dart';
...
class ProductActionsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    UserDatabaseService().isProductFavourite(product.id).then(
      (value) {
      ...
      builder: (context, productDetails, child) {
        return InkWell(
          onTap: () async {
            ...
            bool success = false;
            final future = UserDatabaseService()
